...
(function ($, Drupal) {
        ...
        // Update view on facet item click.
          ...
          $('[data-drupal-facet-id=' + facetId + ']').each(function (index, facet_item) {
            if ($(facet_item).hasClass('js-facets-widget')) {
              ...
              $(facet_item).on('facets_filter.facets', function (event, $elem) {
                $('.js-facets-widget').trigger('facets_filtering');

                updateFacetsView($elem, current_dom_id, view_path);
              });
            }
          });
  ...
  var updateFacetsView = function ($elem, current_dom_id, view_path) {
    // Refresh view.
    ...
    views_ajax_settings.element = $elem[0];
